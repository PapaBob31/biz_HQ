...
electron_1.ipcMain.handle('clover-authorize', function (event, credentials) { return __awaiter(void 0, void 0, void 0, function () {
...
// Printer Handler
electron_1.ipcMain.handle('print-receipt', function (event, saleData) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        console.log("Sending to Star Micronics...");
        // Logic for Star SDK goes here
        return [2 /*return*/, { status: 'printed' }];
    });
}); });
